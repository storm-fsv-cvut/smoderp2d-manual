...
% 
  ...
  \input{./text_cz/mat_a_met/CZmanual_metody}
% 
% 
  ...
  \input{./text_cz/mat_a_met/CZsmoderp_postup}


  \appendix
  \section{Příloha: doplňující tabulky a grafy}\label{sec:priloha}
  \input{./text_cz/mat_a_met/CZmanual_Proloha}

%   \appendix
  \FloatBarrier
  \section{Příloha: další výstupy}\label{sec:priloha2}
  \input{./text_cz/mat_a_met/CZmanual_Priloha2}
