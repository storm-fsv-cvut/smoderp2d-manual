...
% 
% 
\subsection{Povrchový odtok  \acs{oin}, \acs{oout}} \label{sec:povrch_odtok}
...
\section{Plošný povrchový odtok} \label{sec:plosny_odtok}
...
% 
% 
\section{Soustředěný odtok v rýhách} \label{sec:soustredenyodtok}
...
\subsection{Rýhový odtok \acs{oinrill}, \acs{ooutrill}}
