...
V modelu je rovněž zahrnuta intercepční kapacita \acs{PotI}, která se během začátku srážky plní. Výsledná intenzita efektivní srážky v čase $t$ je pak určena jako
