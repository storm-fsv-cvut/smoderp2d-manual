...
V hlavním souboru v balíčku \smod {\tt smoderp2d/main.py} se volají metody ke načtení vstupních dat, $preprocessingu$ a k spuštění samotného výpočtu. V tomto souboru je metoda {\tt run()}. V těle této metody je $if$-konstrukt, který určí princip načtení vstupních dat na základě platformy na, které je model spuštěn. 
